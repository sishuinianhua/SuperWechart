...
import cn.ucai.superwechart.activity.AlertDialog;
import cn.ucai.superwechart.activity.BaiduMapActivity;
import cn.ucai.superwechart.activity.ChatActivity;
import cn.ucai.superwechart.activity.ContextMenu;
import cn.ucai.superwechart.activity.ShowBigImage;
...
import cn.ucai.superwechart.utils.ImageCache;
...
public class MessageAdapter extends BaseAdapter{
	...
	private void setUserAvatar(final EMMessage message, ImageView imageView){
	    if(message.direct == Direct.SEND){
	        //显示自己头像
	        UserUtils.setAppCurrentAvatar(context, imageView);
	    }else{
	        UserUtils.setContactAvatar(context, message.getFrom(), imageView);
	    }
