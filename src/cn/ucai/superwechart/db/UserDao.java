 ...
 */
package cn.ucai.superwechart.db;
...
public class UserDao {
	...
	public static final String USER_TABLE_NAME = "t_superwechart_user";
	...
	public void savaUserAvatar(UserAvatar ua) {
		DemoDBManager.getInstance().saveUserAvatar(ua);
	}

	public UserAvatar getUserAvatar(String userName) {
		UserAvatar ua =DemoDBManager.getInstance().getUserAvatar(userName);
		return ua;
	}

	public void updateNick(UserAvatar ua) {

	}

	public void updateUserNick(UserAvatar ua) {
		DemoDBManager.getInstance().updateUserNick(ua);
	}
}
