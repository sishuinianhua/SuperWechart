...
import cn.ucai.superwechart.applib.model.GroupRemoveListener;
...
import cn.ucai.superwechart.adapter.ExpressionAdapter;
import cn.ucai.superwechart.adapter.ExpressionPagerAdapter;
				...
				try {
					...
					if (buttonSetModeKeyboard.getVisibility() != View.VISIBLE) {
						...
						if (filename != "delete_expression") { // 不是删除键，显示表情
							...
							Class clz = Class.forName("cn.ucai.superwechart.utils.SmileUtils");
							Log.i("main",TAG+clz);
