...
public class PublicGroupsActivity extends BaseActivity {
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            for (EMGroupInfo emgi:returnGroups){
                                if (!SuperWeChatApplication.getInstance().getGaMap().containsKey(emgi.getGroupId())){
                                    groupsList.add(emgi);
                                }
                            }
	...
	private class GroupsAdapter extends ArrayAdapter<EMGroupInfo> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
            ...
            UserUtils.setGroupAvatar(mContext,getItem(position).getGroupId(),(ImageView)convertView.findViewById(R.id.avatar));
			return convertView;
		}
	}
