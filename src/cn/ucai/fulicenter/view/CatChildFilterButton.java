...
import cn.ucai.fulicenter.fragments.CategoryActivity;
    ...
    class CatFilterAdapter extends BaseAdapter {
        ...
        public View getView(int position, View layout, final ViewGroup parent) {
          ...
          //  String url= I.REQUEST_DOWNLOAD_CATEGORY_CHILD_IMAGE_URL+imgUrl;
            ...
            UserUtils.setCategoryChildAvatar(context,imgUrl,holder.ivThumb);
            ...
            holder.layoutItem.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra(I.NewAndBoutiqueGood.CAT_ID, child.getId());
